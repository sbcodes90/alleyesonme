...
function About() {
  return (
    <>
        ...
        <div className="bg-white rounded-3xl w-full p-20 lg:p-20">
      ...
      <section className="bg-cyan-200 p-20">
        <div className=" rounded-2xl ">
        </div>
        <div className="bg-white lg:h-auto p-10  rounded-2xl  ">
       <span> <img src={newBee} alt="honey-bee" className="w-60" />

          <div className="text-black text-center font-bold text-2xl pb-5">About</div>
          <div className="text-black text-left text-lg px-5">
            <div className="text-center pb-5 font-bold">My name is Brandi White AKA Your Favorite Math Teacher! </div>
            <div className="pb-5 text-pretty">I am a proud
            native of South West Philadelphia, PA. My first employment was at a
            ...
            <div className="pt-5">
            Think about it. Do you like math? How do
            ...
            subject into their favorite!</div></div>
          </div>
          </span>
        </div>    
      </section>
